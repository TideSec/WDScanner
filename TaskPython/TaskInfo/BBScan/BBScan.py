...
def save_report_thread(q_results, file,output_file):
...
if __name__ == '__main__':
    ...
    for file in input_files:
        ...
        try:
            ...
            threading.Thread(target=save_report_thread, args=(q_results, file,output_file)).start()
